const AddButton = ({children, onClick, disabled}) => {
    return <div className="w-[25%] flex justify-end">
        <button
            className="flex gap-2 items-center rounded-full py-3 px-5 transition-all ease-in-out
            hover:bg-dark-gray/60 active:bg-dark-gray disabled:hover:bg-transparent"
